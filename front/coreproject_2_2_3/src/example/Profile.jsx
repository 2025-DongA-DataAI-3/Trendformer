...
const handleDeleteAccount = async () => {
  ...
  const toggleLikeFromProfile = (item) => {
    const current = likeState[item.id] || {
      liked: false,
      count: Number(item.saves) || 0,
    };
    ...
    <div style={styles.page}>
          ...
          <div style={styles.avatarWrap}>
            <div style={styles.avatarOuter}>
              ...
              <button
                ...
                onClick={handleClickPhotoChange}
              >
                <Camera size={14} />
              </button>
      ...
      <section style={styles.sectionHead}>
        <h3 style={styles.sectionTitle}>
          {tab === "saved" ? "내 보관함" : "좋아요한 콘텐츠"}
        </h3>
        <p style={styles.sectionSub}>
          {tab === "saved"
            ? "검색과 홈에서 저장한 밈 영상을 모아볼 수 있어요"
            : "좋아요를 누른 콘텐츠를 다시 확인할 수 있어요"}
        </p>
      </section>
      ...
      <section style={styles.cardGrid}>
        {currentData.length > 0 ? (
          currentData.map((item) => {
            const currentLike = likeState[item.id] || {
              liked: false,
              count: Number(item.saves) || 0,
            };
            ...
            return (
              <article key={item.id} style={styles.card}>
                ...
                >
                  ...
                  <span style={styles.cardPlayBadge}>
                    <Play size={12} />
                    보기
                  </span>
                </button>
                ...
                <div style={styles.cardBody}>
                  ...
                  <p style={styles.cardDesc}>
                    {item.desc || `${item.userId || "unknown"}님의 저장 콘텐츠`}
                  </p>
                  ...
                  <div style={styles.metaRow}>
                    <button
                      ...
                      style={{
                        ...styles.metaButton,
                        ...(currentLike.liked ? styles.metaButtonLiked : {}),
                      }}
                      onClick={() => toggleLikeFromProfile(item)}
                    >
                      <Heart
                        size={14}
          ...
          <div style={styles.emptyBox}>
            ...
            <p style={styles.emptyDesc}>
              {tab === "saved"
                ? "홈이나 검색 화면에서 저장 버튼을 누르면 여기에 모입니다."
                : "홈이나 검색 화면에서 좋아요를 누르면 여기에 반영됩니다."}
            </p>
          </div>
        )}
      </section>
        ...
        <div style={styles.modalOverlay} onClick={closeEditModal}>
          <div style={styles.modalBox} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              ...
              <button type="button" style={styles.modalCloseBtn} onClick={closeEditModal}>
                <X size={20} />
              </button>
            </div>
        ...
        <div style={styles.modalOverlay} onClick={closePwModal}>
          <div style={styles.modalBox} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              ...
              <button type="button" style={styles.modalCloseBtn} onClick={closePwModal}>
                <X size={20} />
              </button>
            </div>
            ...
            <form onSubmit={handleSavePassword} style={styles.form}>
              ...
              <div style={styles.modalActionRow}>
                <button type="button" style={styles.cancelBtn} onClick={closePwModal}>
                  취소
                </button>
                <button type="submit" style={styles.saveBtn}>
                  변경
        ...
        <div style={styles.modalOverlay} onClick={closeDeleteModal}>
          <div style={styles.modalBox} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              ...
              <button type="button" style={styles.modalCloseBtn} onClick={closeDeleteModal}>
                <X size={20} />
              </button>
            </div>
            ...
            <div style={styles.deleteNoticeBox}>
              ...
              <p style={styles.deleteDesc}>
                탈퇴를 진행하려면 아래 입력칸에 <strong>회원탈퇴</strong>를 정확히
                입력해주세요.
              </p>
            </div>
            ...
            <div style={styles.modalActionRow}>
              <button type="button" style={styles.cancelBtn} onClick={closeDeleteModal}>
                취소
              </button>
      ...
      {selectedItem && (
        <div style={styles.modalOverlay} onClick={closeDetailModal}>
          <div style={styles.detailModalBox} onClick={(e) => e.stopPropagation()}>
            <button
              type="button"
              style={styles.modalCloseFloatingBtn}
            ...
            <div style={styles.detailInfoBox}>
              <div style={styles.detailHeaderRow}>
                <div style={styles.detailUserBlock}>
                  ...
                  <div>
                    <strong style={styles.detailUserName}>
                      {selectedItem.nickname || selectedItem.userId || "unknown"}
                    </strong>
                    <p style={styles.detailSubText}>
                      {selectedItem.category || "Meme"}
                    </p>
                  </div>
                </div>
              ...
              <div style={styles.detailActionRow}>
                <button
                  ...
                  style={{
                    ...
                    ...(likeState[selectedItem.id]?.liked
                      ? styles.primaryActionBtnLiked
                      : {}),
                  }}
                  onClick={() => toggleLikeFromProfile(selectedItem)}
                >
                  <Heart
                    size={16}
                    fill={likeState[selectedItem.id]?.liked ? "currentColor" : "none"}
                  />
                  좋아요{" "}
                  {likeState[selectedItem.id]?.count ??
                    selectedItem.saves ??
                    0}
                </button>
                ...
                <button
                  ...
                  onClick={() => removeSavedItem(selectedItem.id)}
                >
                  <Bookmark size={16} />
                  저장 해제
                </button>
...
const styles = {
  ...
  deleteConfirmBtn: {
    ...
    border: "none",
    borderRadius: 15,
    background: "linear-gradient(135deg, #b93d5a 0%, #ff5f7d 100%)",
    color: "#fff",
    cursor: "pointer",
    fontSize: 14,
    fontWeight: 800,
